...
//     */
    public static void main(String[] args) throws Exception {
        ...
        String data = "{\"stationCode\":\"33308289A\", \n"
                + " \"serverPasswd\":\"PASSWD-DCP\", \n"
                + " \"transmissionDateTime\":\"2020-12-09 18:01:56\", \n"
                + " \"measures\":[{\"sensorCode\":20, \n"
                + "              \"type\":\"pluvio\", \n"
                + "              \"measurementDateTime\":\"2020-12-09 18:01:56\", \n"
                + "              \"measure\":\"8\"}, \n"
                + "             {\"sensorCode\":21, \n"
                + "              \"type\":\"battery\", \n"
                + "              \"measurementDateTime\":\"2020-12-09 18:01:56\", \n"
                + "              \"measure\":\"143,99977\"}]}";
        String path = "/dados/projetos/projetos.pessoais/bitbucket/doutorado-2/Tese/06_Artigo/Estudo-de-Caso/github/FIBASE-Case-Study/ontologies/OR_OBSNetwork_NewArchitecture.rdf";
